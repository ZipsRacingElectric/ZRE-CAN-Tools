...
IF [%1] == [] (
	"%ZRE_CANTOOLS_DIR%/bin/dashboard-gui.exe" "%ZRE_CANTOOLS_DIR%/config/zr25/vehicle/dashboard_gui.json" "COM*@1000000" "%ZRE_CANTOOLS_DIR%/config/zr25/vehicle/main.dbc"
) ELSE (
