...
#define ERRNO_CAN_EEPROM_VALIDATE_TIMEOUT		1540
#define ERRNO_CAN_EEPROM_IS_VALID_TIMEOUT		1541
#define ERRNO_CAN_EEPROM_MALFORMED_RESPONSE		1542
#define ERRNO_CAN_EEPROM_BAD_RESPONSE_ID		1543
#define ERRNO_CAN_EEPROM_BAD_KEY				1544
#define ERRNO_CAN_EEPROM_BAD_VALUE				1545
#define ERRNO_CAN_EEPROM_BAD_DIMENSION			1546
#define ERRNO_CAN_EEPROM_READ_ONLY				1547
#define ERRNO_CAN_EEPROM_WRITE_ONLY				1548
...
static inline const char* errorMessage (int errorCode)
{
	...
	case ERRNO_CAN_EEPROM_VALIDATE_TIMEOUT:
		return ERRMSG_CAN_EEPROM_VALIDATE_TIMEOUT;
	case ERRNO_CAN_EEPROM_IS_VALID_TIMEOUT:
